...
# PATH
EXEC_PATH="./pj/gq_FetchProjectReport_with_filters_single/"
...
VEGETA_DURATION="1s"
VEGETA_RATE="1"
VEGETA_RESULT_FILE="results.json"
...
ORIGIN_PATH=$(pwd)
go_to "$EXEC_PATH" 
vegeta_attack_with_results "$VEGETA_DURATION" "$VEGETA_RATE" "$VEGETA_RESULT_FILE" "$VEGETA_REPORT_FILE"
go_to "$ORIGIN_PATH"
